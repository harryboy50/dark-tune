...
class SearchResultScreenController extends GetxController
  ...
  // true when the last search request failed (network / unexpected response)
  ...
  Future<void> onDestinationSelected(int value,
    ...
    if (value > 0 &&
      ...
      try {
        ...
        printERROR("Search ($tabName) failed: $e");
  ...
  /// Retry the search after a failure (used by the "Retry" button).
  ...
  Future<void> _getInitSearchResult() async {
    ...
    if (args != null) {
      ...
      try {
        ...
        // without this the loading indicator would spin forever
