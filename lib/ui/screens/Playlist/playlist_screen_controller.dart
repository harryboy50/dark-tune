...
import 'package:darktune/models/thumbnail.dart';
import 'package:darktune/services/permission_service.dart';
import 'package:darktune/ui/screens/Settings/settings_screen_controller.dart';
import 'package:darktune/ui/widgets/snackbar.dart';
import 'package:darktune/utils/helper.dart';
...
class PlaylistScreenController extends PlaylistAlbumScreenControllerBase
  ...
  String _getLocationMessage(String path) {
    if (Platform.isAndroid) {
      return "Downloads/DarkTune";
    } else if (Platform.isIOS) {
      return "Files App > DarkTune";
    } else if (Platform.isWindows || Platform.isLinux || Platform.isMacOS) {
      return "Downloads/DarkTune";
    } else {
