...
> Dark Tune is a re-themed & renamed fork of [Harmony Music](https://github.com/anandnet/Harmony-Music) by anandnet. All features are the same as the original app.
...
# License
```
Dark Tune is based on Harmony Music (by anandnet), a free software licensed under GPL v3.0 with following condition.
...
Dark Tune is not responsible for any infringement of copyright or other intellectual property rights that may result
