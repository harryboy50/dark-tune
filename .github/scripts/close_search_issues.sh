...
The search functionality issue has been fixed in version **v1.12.1**. Please update to the latest version from the [releases page](https://github.com/anandnet/darktune/releases/tag/v1.12.1).

**Download Links:**
- **Android (Universal APK):** [darktune-1.12.1-release.apk](https://github.com/anandnet/darktune/releases/download/v1.12.1/darktune-1.12.1-release.apk)
- **Android (ARM64):** [darktune-1.12.1-arm64-v8a-release.apk](https://github.com/anandnet/darktune/releases/download/v1.12.1/darktune-1.12.1-arm64-v8a-release.apk)
- **Android (ARMv7):** [darktune-1.12.1-armeabi-v7a-release.apk](https://github.com/anandnet/darktune/releases/download/v1.12.1/darktune-1.12.1-armeabi-v7a-release.apk)
- **Windows:** [darktune-1.12.1.exe](https://github.com/anandnet/darktune/releases/download/v1.12.1/darktune-1.12.1.exe)
- **Linux (Debian):** [darktune-1.12.1+26-linux.deb](https://github.com/anandnet/darktune/releases/download/v1.12.1/darktune-1.12.1%2B26-linux.deb)
- **Linux (AppImage):** [darktune-1.12.1+26-linux.AppImage](https://github.com/anandnet/darktune/releases/download/v1.12.1/darktune-1.12.1%2B26-linux.AppImage)
- **Linux (RPM):** [darktune-1.12.1+26-linux.rpm](https://github.com/anandnet/darktune/releases/download/v1.12.1/darktune-1.12.1%2B26-linux.rpm)
...
for issue_num in "${SEARCH_ISSUES[@]}"; do
    ...
    if gh issue comment "${issue_num}" --body "${COMMENT}" --repo anandnet/darktune; then
        echo "  ✓ Comment added to issue #${issue_num}"
        
        # Close the issue
        if gh issue close "${issue_num}" --reason completed --repo anandnet/darktune; then
